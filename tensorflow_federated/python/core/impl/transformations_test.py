...
def _create_chained_calls(functions, arg):
  ...
  that is assignable from `arg`s type each other functional computation in
  `functions` must have a parameter type that is assignable from the previous
